...
public class DelegateCallableStatement<C extends Connection>
extends DelegatePreparedStatement<CallableStatement,C>
implements CallableStatement {

	public DelegateCallableStatement(C connection, CallableStatement statement) {
	...
	@SuppressWarnings("deprecation") public BigDecimal getBigDecimal(int parameterIndex, int scale) throws SQLException {
